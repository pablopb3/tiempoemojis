...
class TweetGaliciaWeatherMapInTestAccountUseCaseTest {

    TweetGaliciaWeatherMapInTestAccountUseCase tweetGaliciaWeatherMapInTestAccountUseCase;
    ...
    void setup() {
        ...
        tweetGaliciaWeatherMapInTestAccountUseCase = new TweetGaliciaWeatherMapInTestAccountUseCase(templateReader, mapService, elTiempoPuntoEsGaliciaWeatherService, twitterApiClientTesting);
    }

    @Test
    void tweetWeather() throws Exception {
        tweetGaliciaWeatherMapInTestAccountUseCase.tweetWeather();
    }
