...
class WeatherEmojiMapperTest {
    ...
    void emojiMapperSunnyDay() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(sunnyWeather, true).equals(WeatherEmoji.SUN));
    }
    ...
    void emojiMapperClearNight() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(clearNight, true).equals(WeatherEmoji.FULL_MOON));
    }
    ...
    void emojiMapperRainyNight() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(rainyNight, true).equals(WeatherEmoji.RAINY_CLOUDS));
    }
    ...
    void emojiMapperStormySky() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.RAINY_STORMY_CLOUDS));
    }
    ...
    void emojiMapperSnowyDay() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.SNOWY_CLOUD));
    }
    ...
    void emojiMapperSunAndSmallClouds() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.SUN_WITH_SMALL_CLOUD));
    }
    ...
    void emojiMapperSunAndMediumClouds() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.SUN_WITH_MEDIUM_CLOUD));
    }
    ...
    void emojiMapperSunAndBigClouds() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.SUN_WITH_BIG_CLOUD));
    }
    ...
    void emojiMapperGreyClouds() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(veryCloudyDaySky, true).equals(WeatherEmoji.GREY_CLOUDS));
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(cloudyNightSky, true).equals(WeatherEmoji.GREY_CLOUDS));
    }
    ...
    void emojiMapperSunWithCloudsAndRain() {
        ...
        Assertions.assertTrue(WeatherEmoji.getEmojiForWeather(stormySky, true).equals(WeatherEmoji.SUN_WITH_BIG_CLOUD_AND_RAIN));
    }
